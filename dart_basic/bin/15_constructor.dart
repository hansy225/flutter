/*
   - Default : 생성자를 선언하지 않으면 제공되는 빈 생성자
   - Named Constructors : 개발자가 생성한 생성자
                        클래스에 대한 여러 생성자를 구현하거나, 추가적인 클래스의 명확을 제공
   - Redirection Constructors : 목적이 동일한 생성자로 전달하기 위함 생성자
                                생성자의 본문이 비어 있지만, 전달된 생성자에 초기값 등을 구현할 때
                                (java의 생성자 오버라이딩과 유사)
